...
function AppDockNavigation() {
    ...
    return (
        <>
            {renderPage()}
            <div className="dock">
                <button className={activeTab === "Subscription" ? "dock-active" : ""} onClick={() => onTabClicked("Subscription")}>
                ...
                <button className={activeTab === "Listen Later" ? "dock-active" : ""} onClick={() => onTabClicked("Listen Later")}>
                ...
                <button className={activeTab === "Search" ? "dock-active" : ""} onClick={() => onTabClicked("Search")}>
                ...
                <button className={activeTab === "Play List" ? "dock-active" : ""} onClick={() => onTabClicked("Play List")}>
                ...
                <button className={activeTab === "Account" ? "dock-active" : ""} onClick={() => onTabClicked("Account")}>
                    <svg className="size-[1.2em]" width="800px" height="800px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" >
